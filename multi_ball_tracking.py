...
class Track:
	...
	def get_id(self, center):
		# cv2.putText(frame, self.track_id, center, cv2.FONT_HERSHEY_SIMPLEX, 3, (0,0,0), 2)
		return self.track_id

	def set_position(self, center):
		self.track_positions = (center)
